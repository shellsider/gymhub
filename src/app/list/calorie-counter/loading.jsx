          ...
          <div className="flex flex-col md:flex-row gap-10">
            ...
            <div className="w-full md:w-1/3">
              <div className="sticky top-24">
                ...
                <div className="bg-gray-100 p-8 rounded-xl animate-pulse border-t-4 border-blue-300">
                  {[...Array(5)].map((_, i) => (
                    <div
                      key={i}
            ...
            <div className="w-full md:w-2/3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                {[...Array(3)].map((_, i) => (
                  <div
                    key={i}
                    className="bg-gray-100 p-6 rounded-xl animate-pulse">
              ...
              {/* Calorie Breakdown */}
              <div className="bg-gray-100 p-8 rounded-xl animate-pulse border-t-4 border-blue-300 min-h-[300px]">
