export default function Loading() {
  return (
    <div className="min-h-screen">
          ...
          <div className="flex flex-col md:flex-row gap-10">
            ...
            <div className="w-full md:w-1/3">
              <div className="sticky top-24">
                ...
                <div className="bg-gray-100 p-8 rounded-xl animate-pulse border-t-4 border-gray-300">
                  {[...Array(8)].map((_, i) => (
                    <div
                      key={i}
            ...
            <div className="w-full md:w-2/3">
              ...
              <div className="bg-gray-100 p-8 rounded-xl animate-pulse border-t-4 border-gray-300 min-h-[400px]">
      ...
      <div className="py-16 px-6 bg-red-500">
        <div className="max-w-4xl mx-auto text-center">
          <div className="w-96 h-8 bg-red-400 rounded mx-auto mb-6"></div>
          <div className="w-full h-4 bg-red-400 rounded mx-auto mb-3"></div>
          <div className="w-3/4 h-4 bg-red-400 rounded mx-auto mb-8"></div>
